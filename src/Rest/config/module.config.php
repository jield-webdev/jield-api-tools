...
use Jield\ApiTools\Rest\Factory\OptionsListenerFactory;
...
return [
    'api-tools-rest'  => [
        ...
        //          */
        //     ],
        //     'controller_class'           => 'Name of Jield\ApiTools\Rest\RestController derivative, if not using that class',
    ...
    'service_manager' => [
        'invokables' => [
            'Jield\ApiTools\Rest\RestParametersListener' => RestParametersListener::class,
        ],
        'factories'  => [
            'Jield\ApiTools\Rest\OptionsListener' => OptionsListenerFactory::class,
        ],
    ],
    'controllers'     => [
        'abstract_factories' => [
