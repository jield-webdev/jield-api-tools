...
class Module
{
    ...
    protected ?MvcRouteListener $mvcRouteListener;
    ...
    /**
     * Override Jield\ApiTools\OAuth2\Service\OAuth2Server service
     *
     * If the Jield\ApiTools\OAuth2\Service\OAuth2Server is defined, and set to the
